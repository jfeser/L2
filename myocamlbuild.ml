(* OASIS_START *)
(* DO NOT EDIT (digest: 7447c022229bfbbe9d42c4057f6fd017) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_library_l2_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_library_l2_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_library_l2_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_library_l2_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_library_l2_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_library_l2_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_cli_native_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          ([
              "oasis_executable_l2_cli_native_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          ([
              "oasis_executable_l2_cli_native_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_cli_native_byte"; "ocaml"; "compile"; "byte"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          ([
              "oasis_executable_l2_cli_native_native";
            ...
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_cli_byte_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_cli_byte_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_cli_byte_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          ([
              "oasis_executable_l2_cli_byte_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_cli_byte_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          ([
              "oasis_executable_l2_cli_byte_native";
              "ocaml";
            ...
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_tests_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_tests_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_tests_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
          (["oasis_executable_l2_tests_native"; "ocaml"; "ocamldep"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-g"])]);
