...
(* OASIS_START *)
(* DO NOT EDIT (digest: f62ea151472ff4a8afd6211c17b76511) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-ocamlfind"; "-j"; "8"];
     test = [];
     doc = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "3l\190\172\186\194\143{\190\206R\144\175S\238\147";
     oasis_exec = None;
