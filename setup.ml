...
(* OASIS_START *)
(* DO NOT EDIT (digest: bd2ecaf932dcef14b07708e657c2bca2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://sisyphus.cs.rice.edu/pliny-web/lambda2/";
          synopsis = "Program synthesis from examples.";
          description =
            Some
              [
                 OASISText.Para
                   "A tool for synthesizing functional programs from input-output examples."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "l2";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "l2_cli_native";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "l2.ml"});
               Executable
                 ({
                     cs_name = "l2_cli_byte";
                     cs_data = PropList.Data.create ();
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Limited_process"; "Process_info"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "timeout";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "timeout_lib_osx";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.ETest ("system", "macosx"), true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/timeout";
                      bs_compiled_object = Best;
                   ...
                   {
                      lib_modules = ["Process_info_osx"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "timeout_lib";
                      lib_findlib_name = Some "osx";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "timeout_lib_linux";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.ETest ("system", "linux"), true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/timeout";
                      bs_compiled_object = Best;
                   ...
                   {
                      lib_modules = ["Process_info_linux"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "timeout_lib";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("yojson", None);
                           InternalLibrary "timeout_lib_osx"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lproc"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, ["-thread"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-thread"])]
                   },
                   {exec_custom = false; exec_main_is = "timeout_osx.ml"});
               Executable
                 ({
                     cs_name = "timeout_linux";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("yojson", None);
                           InternalLibrary "timeout_lib_linux"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "timeout_linux.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "iHd\177CJ\003S\232L\150?\153\237&\015";
     oasis_exec = None;
